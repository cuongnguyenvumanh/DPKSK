...
function loadSubScheduleData() {
    ...
    let list = draft.step2Data && draft.step2Data.lichPhuong ? draft.step2Data.lichPhuong : [];
    if (list.length === 0 && editId && window.MWKDataStore) {
        const master = MWKDataStore.getKskScheduleById(editId);
        if (master && master.step2Data && master.step2Data.lichPhuong) {
            list = master.step2Data.lichPhuong;
        }
    }
